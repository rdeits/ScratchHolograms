...
# require 'gsl'
#
# This program attempts to brute-force scan an arbitrary SketchUp model with no knowledge of the structure of the object. It only sort of works and isn't really usable currently (its results are messy at best, but probably not actually incorrect). Its output format is no longer supported by pattern.py
